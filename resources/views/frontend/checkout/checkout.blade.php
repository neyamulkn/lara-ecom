...
@section('css')
 	<link href="{{'frontend'}}/css/themecss/so_onepagecheckout.css" rel="stylesheet">
@endsection
@section('content')
				...
				<div class="so-onepagecheckout layout1">
					...
					<div class="col-right col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="checkout-content checkout-cart">
								<h2 class="secondary-title"><i class="fa fa-shopping-cart"></i>Order Details  (0.00kg) </h2>
								<div class="box-inner">
											...
											<tbody>
												<tr>
													<td class="text-left name" colspan="2">
														<a href="product.html"><img src="image/catalog/demo/product/travel/2-80x80.jpg" alt="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" title="Bougainvilleas on Lombard Street,  San Francisco, Tokyo" class="img-thumbnail"></a>
